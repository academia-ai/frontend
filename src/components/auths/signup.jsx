    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-1.5">
        ...
        <input
          ...
          disabled={loading}
        />
        <p className="text-xs text-neutral-500 ml-1">Please use your educational email</p>
      </div>
...
>
  {showPassword ? (
    ...
    <Eye size={16} className="text-neutral-300 hover:text-white" />
      ...
      <div className="space-y-1.5">
        <label className="text-xs font-medium text-neutral-400 ml-1">Confirm Password</label>
        <div className="relative">
          <input
